...
def get_connection():
    ...
    if user_access_token:
        # In Databricks Apps, user authorization forwards an OAuth user token.
        # Use the connector's Statement Execution API path instead of the
        # legacy Thrift OpenSession path. This avoids environment-specific
        # Thrift handshake failures while still enforcing the signed-in
        # user's Unity Catalog and SQL Warehouse permissions.
        return sql.connect(
